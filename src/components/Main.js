...
const PortfolioItem = styled.div`
  ...
  .image-container {
    ...
    div {
      position: relative;
      ${props => !props.className && 'margin-top: 30px'};
      left: 2.5%;
      width: 95%;
      &.text {
        position: relative;
...
const MsgSubmit = styled.li`
  position: relative;
  top: 10px;
  ${props => props.error && 'color: #f87272'};
  line-height: 1;
  margin-top: 15px;
  font-size: 1.3rem;
  text-align: center;
    ...
    return (
      <div ref={this.props.setWrapperRef} id="main" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
        ...
        <article id="portfolio" className={`${this.props.article === 'portfolio' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <PortfolioItem>
            <span className="port-heading"><h3>2-P Online Chess</h3> — <span><a href="http://github.com/dstarrtrey/Chess-Board-2Player">GitHub</a> | <a href="http://dstarrtrey.github.io/Chess-Board-2Player">Demo</a></span></span>
            <div className="image-container">
